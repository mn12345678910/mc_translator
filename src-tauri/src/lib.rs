...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_gui_init_state,
            commands::derive_ui_state,
            commands::derive_toggle_labels_cmd,
            commands::get_gui_css_vars,
            commands::derive_palette_state_cmd,
            commands::derive_default_prompts,
            commands::setup_dev_mock,
            commands::derive_panel_state_cmd,
            commands::normalize_form_config_cmd,
            commands::build_form_config_cmd,
            commands::build_style_from_form_cmd,
            commands::toggle_theme_style_cmd,
            commands::apply_palette_mutation_cmd,
            commands::clear_palette_override_cmd,
            commands::derive_config_ui_state_cmd,
            commands::get_dictionary_page,
