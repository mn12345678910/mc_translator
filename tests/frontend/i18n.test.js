...
describe('i18n.js 介面語言模組', () => {
            ...
            if (cmd === 'derive_toggle_labels_cmd') {
                ...
                return {
                    'chk-glossary-priority':
                        cfg.glossary_priority === 'user' ? labels.glossary_priority_user : labels.glossary_priority_official,
                    ...
                    'chk-debug-log':
                        cfg.enable_debug_log ? labels.label_enable_debug_log : labels.label_disable_debug_log,
                    'chk-debug-tools': cfg.show_debug_tools ? labels.label_hide_debug_tools : labels.label_show_debug_tools,
    ...
    it('updateToggleStateLabel 應該正確更新所有開關文字', async () => {
        stateModule.state.currentLabels = {
    ...
    describe('額外涵蓋範圍 (Coverage Extension)', () => {
        ...
        it('updateToggleStateLabel 應該正確更新剩餘的跳過開關文字', async () => {
            stateModule.state.currentLabels = {
        ...
        it('updateToggleStateLabel 應該處理 chk-fast-convert 特殊情況', async () => {
            stateModule.state.currentLabels = {
        ...
        it('updateToggleStateLabel 應該處理 chk-debug-log 和 chk-debug-tools', async () => {
            stateModule.state.currentLabels = {
